...
densities and are presented in Table~\ref{tab:positions}.  Interested readers
...
the data, the logistic regression fit yields $S_{\rm trans} = 24\,$mJy,
...
as GN20 and HFLS3 may be much more rare than previously thought.
...
\begin{enumerate}
    ...
    \item When a {\it Herschel} source comprises multiple ALMA counterparts,
        ...
        \citet{HB13}.  This conclusion remains true even when we degrade our
